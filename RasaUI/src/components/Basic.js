   ...
   useEffect(()=>{
    ...
    const rasaAPI = async function handleClick(name,msg) {
        ...
        //chatData.push({sender : "user", sender_id : name, msg : msg});
            ...
            //endpoints.yml -> action_endpoint url goes here
          await fetch('http://localhost:6969/webhooks/rest/webhook', {
            method: 'POST',
            headers: {
                        ...
                        <div className="row">
                            <form style={{display: 'flex'}} onSubmit={handleSubmit}>
                                ...
                                <div className="col-2 cola">
                                    <button type="submit" className="circleBtn" > Send</button>
                                </div>
                            </form>
                        </div>
                    </div>
